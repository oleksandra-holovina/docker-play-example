...
# TODO: Did this produce no output when it has no warnings?
./run scalastyle
```
...
Lexie is an Associate Principal Engineer at OCC and [has a
blog](https://medium.com/@Oleksandra_Holovina) where she writes about software
development.

You should write a paragraph or 2 to replace the placeholder information I put
just to fill up the space to see what it looks like. Also, I'm interested in
your design input on how to best to present this information now that there's
2 authors.
